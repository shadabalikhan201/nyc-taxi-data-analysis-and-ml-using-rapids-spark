...
# the License.  You may obtain resources copy of the License at
#
...
# This script is resources basic example script to get resource information about NVIDIA GPUs.
...
# It outputs resources JSON formatted string that is expected by the
# spark.{driver/executor}.resource.gpu.discoveryScript config.
#
# Example output: {"name": "gpu", "addresses":["0","1","2","3","4","5","6","7"]}

ADDRS=`nvidia-smi --query-gpu=index --format=csv,noheader | sed -e ':resources' -e 'N' -e'$!ba' -e 's/\n/","/g'`
